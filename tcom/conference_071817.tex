...
Random pattern that is followed while embedding data should be available at the destination to retrieve the same data
i.e it is necessary to transfer the random pattern that is generated to the destination.\\
\section{Ease of Use}
